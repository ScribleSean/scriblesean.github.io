  ...
  return <main ref={root} className={`${styles.page} ${embedded ? styles.embedded : ""} ${reduced ? styles.reduced : ""}`} onClick={navigate}>
    ...
    <section id="work" className={styles.section}>
      ...
      <div className={styles.widgets}>
        ...
        <article className={`${styles.widget} ${styles.repair}`}><div className={styles.widgetMeta}><span>EARLY EXPLORATION</span><span>In progress</span></div><h3>Repurposing an iPad</h3><p>I’m turning an old iPad into a dedicated computing device, exploring what I can build with its own hardware and a custom interface.</p></article>
