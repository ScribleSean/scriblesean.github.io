  ...
  return <main ref={root} className={`${styles.page} ${embedded ? styles.embedded : ""} ${reduced ? styles.reduced : ""}`} onClick={navigate}>
    ...
    <section id="work" className={styles.section}>
      ...
      <div className={styles.widgets}>
        <article className={`${styles.widget} ${styles.observatory}`}><div className={styles.widgetMeta}><span>LOCAL DESKTOP APP</span><span>Early preview ↗</span></div><h3>Workspace<br /><em>Observatory</em></h3><p>Screen time, AI usage, and dictation stats in one place. Built to run locally.</p><a href="https://scriblesean.github.io/observatory/" target="_blank" rel="noreferrer" className={styles.screenLink}><Image src="/scene/observatory-demo.png" alt="Workspace Observatory with fictional sample data" width={1280} height={720} /><span>Explore the synthetic demo ↗</span></a></article>
        ...
        <article className={`${styles.widget} ${styles.repair}`}><div className={styles.widgetMeta}><span>EARLY EXPLORATION</span><span>Paused</span></div><h3>Repurposing an iPad</h3><p>Exploring how to turn an old iPad into a dedicated computing device with a custom interface. This project is currently paused.</p></article>
        <article className={`${styles.widget} ${styles.orbit}`}><span className={styles.orbitMark} aria-hidden="true">◎</span><div className={styles.widgetMeta}><span>PERSONAL PROJECT</span><span>Shelved</span></div><h3>Orbit</h3><p>A personal assistant project for my Mac. I’ve shelved it while focusing on other work.</p></article>
      </div>
